...
$url_manager_id=$_GET["dlt_id"];
}
if(isset($_POST["delete"])){
$delete=$_POST["delete"];

$query="delete  from `url_manager` where `url_manager_id`='$url_manager_id'";
...
<div class="col-md-12">
               ...
               <form method="post">
                ...
                <input type="hidden" name="delete" value="<?php echo $url_manager_id; ?>" />
                 </form>
              </div>
             <div class="col-md-6">
